...
var FilePlayer = exports.FilePlayer = function (_Component) {
  ...
  _createClass(FilePlayer, [{
    ...
    value: function removeListeners() {
      ...
      if (this.dash) {
        this.dash.off(dashjs.MediaPlayer.events.BUFFER_EMPTY, this.props.onBuffer);
      } else if (this.hls) {
    ...
    value: function load(url) {
      ...
      if (this.shouldUseDASH(url)) {
        (0, _utils.getSDK)(DASH_SDK_URL.replace('VERSION', dashVersion), DASH_GLOBAL).then(function (dashjs) {
          ...
          _this2.dash.on(dashjs.MediaPlayer.events.BUFFER_EMPTY, _this2.props.onBuffer);
        });
      }
